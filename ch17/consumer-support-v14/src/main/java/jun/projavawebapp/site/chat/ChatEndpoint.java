...
import jun.projavawebapp.site.SessionRegistry;
import jun.projavawebapp.site.UserPrincipal;
...
public class ChatEndpoint
{
    ...
    {
        private static final String HTTP_SESSION_KEY = "jun.projavawebapp.ws.http.session";
        private static final String PRINCIPAL_KEY = "jun.projavawebapp.ws.user.principal";
        private static final String LOCALE_KEY = "jun.projavawebapp.ws.user.locale";
