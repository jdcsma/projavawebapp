...
<%--@elvariable id="ticket" type="jun.projavawebapp.site.Ticket"--%>
<%--@elvariable id="comments" type="org.springframework.data.domain.Page<jun.projavawebapp.site.TicketComment>"--%>
