...
@EnableJpaRepositories(
        basePackages = "jun.projavawebapp.site.repositories",
...
public class RootContextConfiguration implements
    ...
    public Jaxb2Marshaller jaxb2Marshaller() {
        ...
        marshaller.setPackagesToScan(new String[]{"jun.projavawebapp.site"});
        return marshaller;
    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean() {
        ...
        adapter.setDatabasePlatform("org.hibernate.dialect.MySQL8DBDialect");

        LocalContainerEntityManagerFactoryBean factory =
                new LocalContainerEntityManagerFactoryBean();
        factory.setJpaVendorAdapter(adapter);
        factory.setDataSource(this.springJpaDataSource());
        factory.setPackagesToScan("jun.projavawebapp.site.entities");
    ...
    public ErrorHandler taskErrorHandler() {
        return t -> schedulingLogger.error(
                "Unknown error occurred while executing task.", t);
    }

    public RejectedExecutionHandler taskRejectedExcutionHandler() {
        return (r, e) -> schedulingLogger.error(
    ...
    public ThreadPoolTaskScheduler taskScheduler() {
        ...
        scheduler.setErrorHandler(this.taskErrorHandler());
        scheduler.setRejectedExecutionHandler(this.taskRejectedExcutionHandler());
        return scheduler;
    }
