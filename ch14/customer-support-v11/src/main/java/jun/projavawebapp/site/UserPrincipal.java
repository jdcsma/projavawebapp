...
public class UserPrincipal implements
        Principal, Cloneable, Serializable {
    ...
    public static Principal getPrincipal(HttpSession session) {
        return session == null ? null :
                (Principal) session.getAttribute("jun.projavawebapp.user.principal");
    }

    public static void setPrincipal(HttpSession session, Principal principal) {
        session.setAttribute("jun.projavawebapp.user.principal", principal);
    }
}
