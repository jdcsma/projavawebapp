<%--@elvariable id="discussion" type="jun.projavawebapp.site.dao.entity.Discussion"--%>
<%--@elvariable id="replies" type="java.util.List<jun.projavawebapp.site.dao.entity.Reply>"--%>
<!DOCTYPE html>
<html>
<head>
