<%--@elvariable id="applicants" type="java.util.List<jun.projavawebapp.site.entities.Applicant>"--%>
<!DOCTYPE html>
<html>
<head>
...
<br/>
<b>Add a Resume to an Applicant</b><br/>
<i>Since you are listing applicants but resumes are lazy loaded and not
    fetched for every applicant in the service, you will need to query
    the database to see any resumes you add.</i>
<form:form method="post" modelAttribute="resumeForm"
