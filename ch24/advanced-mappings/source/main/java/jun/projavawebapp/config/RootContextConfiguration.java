...
public class RootContextConfiguration implements
    ...
    @Bean
    public DataSource advancedMappingsDataSource() {
        JndiDataSourceLookup lookup = new JndiDataSourceLookup();
        return lookup.getDataSource("jdbc/AdvancedMappings");
    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean() {
        ...
        factory.setPackagesToScan(
                "jun.projavawebapp.site.entities",
                "jun.projavawebapp.site.converters"
        );
