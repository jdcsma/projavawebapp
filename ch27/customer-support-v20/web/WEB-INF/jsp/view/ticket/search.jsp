<%--@elvariable id="searchForm" type="jun.projavawebapp.site.TicketController.SearchForm"--%>
<%--@elvariable id="searchPerformed" type="boolean"--%>
<%--@elvariable id="results" type="org.springframework.data.domain.Page<jun.projavawebapp.site.repositories.SearchResult<jun.projavawebapp.site.entities.Ticket>>"--%>
