...
<%--@elvariable id="results" type="org.springframework.data.domain.Page<jun.projavawebapp.site.repositories.SearchResult<jun.projavawebapp.site.entities.ForumPost>>"--%>
<!DOCTYPE html>
<html>
    <head>
        <title>Search</title>
