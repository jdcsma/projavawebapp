...
public class RootContextConfiguration implements
    ...
    public Jaxb2Marshaller jaxb2Marshaller() {
        ...
        marshaller.setPackagesToScan("jun.projavawebapp.site");
        return marshaller;
    }

    @Bean
    public DataSource advancedCriteriaDataSource() {
        JndiDataSourceLookup lookup = new JndiDataSourceLookup();
        return lookup.getDataSource("jdbc/AdvancedCriteria");
    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean() {
        ...
        factory.setDataSource(this.advancedCriteriaDataSource());
