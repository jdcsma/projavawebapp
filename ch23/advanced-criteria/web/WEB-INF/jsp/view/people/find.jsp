<%--@elvariable id="searchForm" type="jun.projavawebapp.site.MainController.SearchForm"--%>
<%--@elvariable id="results" type="org.springframework.data.domain.Page<jun.projavawebapp.site.entities.Person>"--%>
<!DOCTYPE html>
<html>
<head>
        ...
        <c:otherwise>
            ...
            <c:choose>
                ...
                <c:otherwise><a href="javascript:void 0;"
                                onclick="searchForm.elements['paging.page'].value = '${i}'; searchForm.submit();">${i}</a></c:otherwise>
            </c:choose>&nbsp;
        </c:forEach><br/>
